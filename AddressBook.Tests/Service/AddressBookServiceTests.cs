...
using AddressBookTests.TestSetup;
using ModelLayer.Model;

namespace AddressBookTests.Service.Tests.Services
{
    [TestFixture]
    public class AddressBookServiceTests
    {
        ...
        public void Setup()
        {
            ...
            _addressBookService = new AddressBookService(addressBookRepo);
        }
        ...
        {
            // Arrange
            _addressBookService.AddContact(new AddressBookEntry { FirstName = "A", LastName = "B", Email = "a@b.com" });
            _addressBookService.AddContact(new AddressBookEntry { FirstName = "C", LastName = "D", Email = "c@d.com" });
